...
<body>
	...
	<section class="contents d-flex justify-content-center">
		<div class="join-box">
			...
			<input type="text" id="loginIdInput" placeholder="로그인 아이디" class="form-control mt-4">
			<input type="text" id="passwordInput" placeholder="비밀번호" class="form-control mt-4">
			<input type="text" id="passwordConfirmInput" placeholder="비밀번호 확인" class="form-control mt-4">
			...
			<button type="button" id="joinBtn" class="btn btn-info btn-block mt-5">가입</button>
		</div>
	</section>
